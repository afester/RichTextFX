 ...
 */
public class GenericStyledTextAreaModel<PS, SEG, S>
        implements
     ...
     * specified (yet).
     */
    public GenericStyledTextAreaModel(PS initialParagraphStyle, S initialTextStyle, TextOps<SEG, S> segmentOps) {
        this(initialParagraphStyle, initialTextStyle, segmentOps, true);
    }

    public GenericStyledTextAreaModel(PS initialParagraphStyle, S initialTextStyle, TextOps<SEG, S> segmentOps, boolean preserveStyle
    ) {
        this(initialParagraphStyle, initialTextStyle,
                new GenericEditableStyledDocument<>(initialParagraphStyle, initialTextStyle, segmentOps),
     ...
     */
    public GenericStyledTextAreaModel(PS initialParagraphStyle, S initialTextStyle,
    ...
    public GenericStyledTextAreaModel(
