 ...
 */
public class GenericEditableStyledDocument<PS, SEG, S> implements EditableStyledDocument<PS, SEG, S> {
    ...
    GenericEditableStyledDocument(Paragraph<PS, SEG, S> initialParagraph/*, SegmentOps<SEG, S> segmentOps*/) {
